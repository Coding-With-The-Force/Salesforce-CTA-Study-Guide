...
![Price Book Objects ERD](assets/images/CTA_OOTB_Object_ERDs/sales-cloud-product-price-book-data-model.png)  

***

### Opportunity Forecasting Objects  

![Opportunity Forecasting Objects ERD](assets/images/CTA_OOTB_Object_ERDs/sales-cloud-opportunity-forecasting-data-model.png)


### Enterprise Territory Management Objects  

![Enterprise Territory Management Objects ERD](assets/images/CTA_OOTB_Object_ERDs/sales-cloud-territory-management-data-model.png) 