...
1) Global COE - This is the enterprise wide COE that tries to maintain a vision for the entire business/suite of technology the business uses. This sets the baseline architecture, security, data standards, etc for all IT groups within a business  

2) Local COE - This is a COE local to your project. It ensures that all project teams working in your Salesforce Org (or tech stack) follow the same rules, and align to the businesses vision for what needs to be delivered to customers.  

***

### Common Governance Acronyms/Matrixes  
